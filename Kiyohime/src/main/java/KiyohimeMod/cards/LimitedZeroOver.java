...
public class LimitedZeroOver extends CustomCard {

    public static final String ID = "KiyohimeMod:LimitedZeroOver";
    public static final String IMG_PATH = "Kiyohime/images/cards/LimitedZeroOver.png";
