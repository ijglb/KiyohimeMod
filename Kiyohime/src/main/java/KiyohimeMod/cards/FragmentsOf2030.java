...
public class FragmentsOf2030 extends CustomCard {

    public static final String ID = "KiyohimeMod:FragmentsOf2030";
    public static final String IMG_PATH = "Kiyohime/images/cards/FragmentsOf2030.png";
