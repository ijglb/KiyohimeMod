...
public class CommandCard_Buster extends AbstractAttackCard {

    public static final String ID = "KiyohimeMod:CommandCard_Buster";
    public static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG_PATH = "Kiyohime/images/cards/CommandCard_Buster.png";
    ...
    public void applyPowers() {
        if(AbstractDungeon.player instanceof Kiyohime){
            ...
            int hits = servant.getBusterHits();
