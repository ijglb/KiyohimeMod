...
public class BlueBlackKey extends AbstractAttackCard {

    public static final String ID = "KiyohimeMod:BlueBlackKey";
    public static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG_PATH = "Kiyohime/images/cards/BlueBlackKey.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new ApplyStackablePowerAction(p, p,
                new ArtsUPPower(p, this.magicNumber, 1), this.magicNumber, 1, true));
