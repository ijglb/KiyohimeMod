...
public class FormalCraft extends CustomCard {

    public static final String ID = "KiyohimeMod:FormalCraft";
    public static final String IMG_PATH = "Kiyohime/images/cards/FormalCraft.png";
