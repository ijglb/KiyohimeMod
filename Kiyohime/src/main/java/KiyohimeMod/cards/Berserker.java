...
public class Berserker extends CustomCard {

    public static final String ID = "KiyohimeMod:Berserker";
    public static final String IMG_PATH = "Kiyohime/images/cards/Berserker.png";
